defmodule BinaryExtendedGcd.MixProject do
  use Mix.Project
  ...
  def project do
    [
      ...
      deps: deps(),
      name: "Binary extended gcd",
      description: "A fast implementation of the binary extended GCD algorithm for Elixir.",
      docs: docs(),
      package: package(),
      aliases: aliases(),
      dialyzer: dialyzer()
  ...
  def package do
    [
      name: :binary_extended_gcd,
      licenses: ["Apache-2.0"],
      links: %{"GitHub" => "https://github.com/zacky1972/binary_extended_gcd"}
    ]
  end
